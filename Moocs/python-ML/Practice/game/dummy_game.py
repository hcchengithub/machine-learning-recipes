...
class GameState:
    def __init__(self):
        self.screen = np.ones((100, 100), np.float32) * 255  #  shape --> (100, 100) 都是 255 白色的
        self.screen = cv2.cvtColor(self.screen, cv2.COLOR_GRAY2BGR)  #  shape --> (100, 100, 3) 變成 RGB pixcel
        self.steps = 0
