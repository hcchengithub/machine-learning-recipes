...
import random, time, pygame, sys, pdb, numpy as np
...
MOVESIDEWAYSFREQ = 0.15  # 沒有用到！
MOVEDOWNFREQ = 0.1  # 沒有用到！
...
class GameState:
	...
	def frame_step(self,input):
		...
		# mooc14868652 同學解決了左右移動時一跳兩格的問題 
		# http://www.icourse163.org/learn/BIT-1001872001?tid=1001965001#/learn/forumdetail?pid=1003595639
