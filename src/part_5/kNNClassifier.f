    ...
    if __name__ == '__main__' or True:
        ...
        import sys
        sys.path.append(r'c:\Users\hcche\Documents\GitHub\machine-learning-recipes\src\part_5')
        ...
        #IRIS DATASET
        feature_set = numpy.loadtxt(r'c:\Users\hcche\Documents\GitHub\machine-learning-recipes\src\part_5\Fisher.csv',delimiter = ',',skiprows = 1,usecols = (1,2,3,4))
        label_set   = numpy.loadtxt(r'c:\Users\hcche\Documents\GitHub\machine-learning-recipes\src\part_5\Fisher.csv',delimiter = ',',skiprows = 1, usecols = (0,))
